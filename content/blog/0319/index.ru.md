...
Чтобы упростить управление своим контейнерным хозяйством, я написал простое [приложение-индикатор](https://unity.ubuntu.com/projects/appindicators/) для //Ubuntu/Unity// с логичным названием [Docker Indicator](https://github.com/yktoo/indicator-docker).
...
Так же, как и [Sound Switcher Indicator][route:/blog/group,id:12], этот индикатор написан на //Python 3//.

Сначала нужно вручную установить [Docker Python API](https://github.com/docker/docker-py) — к сожалению, в репозиториях Убунту как сам //Docker//, так и его //API// очень старых версий. Установка в //Ubuntu// очень проста:
...
А вообще, в свете [недавних новостей](https://insights.ubuntu.com/2017/04/05/growing-ubuntu-for-cloud-and-iot-rather-than-phone-and-convergence/) об отказе //Canonical// от развития //Unity// будущее индикаторов в целом довольно туманно…
