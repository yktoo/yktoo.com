...
Если слово {{< fl "RSS" >}} не вызывает у вас никаких ассоциаций, теперь у вас есть возможность {{< intref "/blog/subscribe" "подписаться" >}} на обновления блога через старый добрый емэйл. Отписаться, разумеется, можно в любой момент.
...
См. также {{< intref "/blog/subscribe" "остальные варианты подписки" >}}.
