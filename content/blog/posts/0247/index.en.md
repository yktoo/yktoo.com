...
So what is all that 4K video about? Firstly, plugging in an external USB drive turned out to be the only way to play it. My Mac Mini, which I use as a media PC, is only capable of 1920×1080. And if you play video {{< intref "0246" "over DLNA" >}}, it cannot keep up with the FPS.
...
*Next:* {{< intref "0248" "Part six. Location, conclusions" >}}
