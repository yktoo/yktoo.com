...
* **13:50** — Королевская процессия отбывает обратно в Нордейнде и там происходит так называемая {{< wiki "Balkonscène" "nl" "балконная сцена" >}} — королевская семья является народу с балкона дворца.
...
Поскольку основные положения речи утекли заранее, основной интригой дня был вопрос, останется ли у короля борода. Борода осталась, монеты и марки можно не перевыпускать.
...
* Госдолг находится под контролем, при этом расходы бюджета могут быть ещё уменьшены.
* Покупательная способность повышается, бюджетное сальдо также растёт.
* Прогноз роста экономики положительный, но насчёт как долго так будет, есть некоторые сомнения. В качестве факторов риска названы Брекзит и торговые войны (привет Трампу).
* Ожидаются дополнительные инвестиции в публичный сектор: здравоохранение, оборону, полицию, дороги и железные дороги (йеее).
* Дополнительные инвестиции в сферу начального образования и подготовку педагогов.
...
* В приоритетах стабильное развитие страны в предстоящие 20-30 лет. Для этого быдет создан фонд, инвестирующий в образование, инновации и инфраструктуру.
* Продолжительность жизни растёт, но одновременно увеличивается нагрузка на здравоохранение, планируются реформы в этой сфере.
...
* Будет создан некий «молодёжный парламент» ({{< fl "jongerenparlement" >}}) для представления интересов молодёжи.
...
* Нужны новые шаги в области миграционной политики, «каждая страна должна вносить свой вклад». Мигранты, чинящие безобразие, должны лишаться права пребывания в странах ЕС.

После окончания речи весь зал встаёт и выкрикивает: «Да здравствует король! Ура! Ура! Ура!»

## Miljoenennota

Конкретные цифры содержатся в {{< fl "Miljoenennota" >}}, бюджетном меморандуме, подготовленном министерством финансов и передаваемом министром Парламенту в специальном чемоданчике.
...
* Планируется суммарное снижение налогов на граждан на **3 млрд** евро. Увеличатся налоговые вычеты работающим, снизится налог на доходы.
* Покупательная способность выросла в среднем на **2,1%**.
* Больше всего в выигрыше работающие; пенсионеры выиграют в среднем 1,1%.
* Налог на прибыль крупных компаний, вопреки ожиданием, не будет уменьшен.
* {{< fl "Zelfstandigenaftrek" >}} (вычет для индивидуальный предпринимателей) со следующего года будет постепенно уменьшаться (а вот это они зря!).
...
* Стоимость пачки сигарет вырастет на **1** евро, все пачки должны выглядеть одинаково, в супермаркетах запрещено выставлять их на обозрение.

## Хорошо быть королём

Ещё кое-что интересное из документов о бюджете:

* Годовая зарплата короля Виллем-Александр вырастет на **99 тыс.** евро, до **€ 949 000**. Плюс **€ 4 937 000** на жалование персоналу и прочие расходы.
* Кронпринцесса Амелия получит в день свого совершеннолетия 7 декабря 2021 года подарок в виде **€ 107 000**, а с 2022 года **€ 282 000** в качестве зарплаты и **€ 1 305 000** на покрытие расходов.
* На перелёты монархическому дому выделено вместо **€ 860 000** лишь **€ 810 000**. Летать придётся чуть экономнее.

## Что такое Prinsjesdag?
...
Его дата тоже менялась; долгое время {{< fl "Prinsjesdag" >}} проводился в понедельник, но у парламентариев возникали трудности с приездом в Гаагу: им приходилось путешествовать в воскресенье, «день покоя» в христианской традиции. В **1887** году событие официально перенесли на вторник. Нынче день его проведения, третий вторник сентября, прописан в Конституции Нидерландов. Также там определено, что в этот же день представляется бюджет.
...
Фанаты королевского дома в этот день одеваются в {{< a "/tags/оранжевая-лихорадка" "оранжевое" >}} и шляпы (атрибут королевы!) и стоят вдоль маршрута процессии, чтобы лично увидеть карету с монархом и его супругой.
