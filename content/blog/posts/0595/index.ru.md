...
Руководитель Нидерландского центра мониторинга онкологических заболеваний {{< fl "IKNL" >}} Петер Хаугенс ({{< fl "Peter Huijgens" >}}) {{< a "https://www.ad.nl/binnenland/kankerexpert-wil-verbod-op-zonnebanken-belachelijk-idee-dat-bruin-worden-gezond-is~a3d1ec78a/" "считает" >}}, что голландцы должны изменить своё отношение к солнечному загару и осознать риск, который он приносит.

Дело в том, что в последние пару лет отмечается {{< a "0443" "резкий рост" >}} количества случаев рака кожи, являющегося самым распространённым видом онкологических заболеваний в Нидерландах — он диагностируется более чем у половины всех пациентов.
...
Дерматолог медицинского центра Эразмского университета ({{< fl "Erasmus MC" >}}) Марлис Ваккее ({{< fl "Marlies Wakkee" >}}), специализирующаяся на раке кожи, ссылается на масштабное исследование, результаты которого были {{< a "https://www.bmj.com/content/345/bmj.e4757.long" "опубликованы" >}} в {{< fl "British Medical Journal" >}}:
...
Госсекретарь по вопросам здравоохранения Пол Блокхаус ({{< fl "Paul Blokhuis" >}}) не поддерживает идею запрета соляриев, однако собирается запустить информационно-просветительскую кампанию, план которой ({{< a "https://www.rivm.nl/bibliotheek/rapporten/2019-0078.pdf" "Zonkrachtactieplan" >}}) разработало в {{< yearp 2019 "прошлом" >}} году.
