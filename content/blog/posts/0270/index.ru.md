...
Точкой назначения был выбран австрийский {{< wiki "Зёльден_(Австрия)" "ru" "Зёльден" >}} ({{< wiki "Sölden" "en" "Sölden" >}}), расположенный в Тироле, — так же, как и Ишгль, где я {{< intref "0239" "был год назад" >}}.
...
Городок Зёльден, в остальном очень похожий на Ленгенфельд, отличается от него наличием обширной горнолыжной зоны. Она несколько меньше, чем в {{< intref "0239" "Ишгле" >}} (**33** подъёмника против **45** и **145 км** склонов против **238 км** в Ишгле), но в целом какая-то более запутанная.
