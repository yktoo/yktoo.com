...
Я всё продолжаю размышлять о своём недавнем {{< intref "0257" "визите" >}} на родину.
...
Именно этой религии я обязан незабываемым временем в храме под названием {{< intref "0257" "«Почта России»" >}}.
