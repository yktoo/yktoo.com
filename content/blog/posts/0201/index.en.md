...
The new version makes use of GTK+ 3 and the trendy GObject Introspection (GIRepository). You can [install]({{< relref "/software/sound-switcher-indicator" >}}) it, as usual, from my [Launchpad PPA](https://launchpad.net/~yktooo/+archive/ppa/).
