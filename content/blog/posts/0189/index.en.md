...
It's been two years of suffering from the speakers built into my {{< intref "0120" "iMac" >}}. The speakers, despite all Apple's marketing noise and even two 17 Watt power amps, suck big time. I've already {{< intref "0141" "connected" >}} my AV receiver via Bluetooth, but it's quite a hassle to start it up every time. Another issue is that Logitech Bluetooth adapter gives a very low output level, which requires setting receiver's volume to -20 dB every time I power it up.
...
**See also**: {{< intref "0198" "Tackling M-Audio Studiophile speaker power-off popping sound" >}}
