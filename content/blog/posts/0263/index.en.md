...
The structure of the website has also been revisited: the blog feed is now right on the {{< intref "/" "home page" >}}, and other sections have been moved around too. Due to that your RSS reader might show the last posts once again, sorry for that.
...
So welcome, and should you spot any stupid (or not-so-stupid) mistake, please let me know via the {{< intref "/about/contact" "feedback form" >}}. Thanks in advance!
