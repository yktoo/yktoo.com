...
* **Входы и выходы**
    ...
    * {{< intref "0245" "Камера" >}}: приобретается отдельно, подключается по USB
* **Поддержка Smart TV**
    * Samsung Smart Hub
...
*Далее:* {{< intref "0244" "Часть вторая. Подключение и управление" >}}
