...
В продолжение {{< intref "0307" "темы о «безупречной службе»" >}} и во исполнение {{< intref "0302" "обещания" >}} немного расскажу о том, как меня занесло в предприниматели. Рассказ получается длинный, поэтому разобью его на несколько частей.
...
<p></p>
Если прожить в Нидерландах пять лет и {{< intref "0187" "сдать" >}} языковой экзамен, можно подать либо на вид на жительство на неограниченный срок ({{< fl "verblijfsvergunning onbepaalde tijd" >}}), либо сразу на голландское гражданство (как {{< intref "0219" "поступил" >}} я). В обоих вариантах ограничение на трудоустройство снимается.
...
*Продолжение:* {{< intref "0310" "Лица и формы" >}}
