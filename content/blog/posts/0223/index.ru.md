...
В {{< a "0222" "прошлой части" >}} я упоминал, что несколько лет назад Хаутену присвоили почётное звание «лучшего велогорода». Помимо этого, этот малозаметный объект на карте Голландии может похвастаться ещё несколькими наградами:
...
Особенно мне нравится желтоватый кирпич, напоминающий {{< a "0035" "южную Бельгию" >}}:
...
Некогда по этим местам проходила граница Римской империи. Соответствующая часть городской истории отражена, например, в названии {{< a "0221" "железнодорожной станции" >}} {{< fl "Houten Castellum" >}} ({{< fl "castellum" >}} — это римская крепость), а все улицы вокруг станции носят итальянские названия:
