...
На ней же, кстати, [работает](0772) и небезызвестный сокращатель ссылок [once.to](https://once.to/once-yktoo) — вообще, {{< fl "Kubernetes" >}} просто замечательная платформа: мощная, гибкая и при этом опенсорсная.
