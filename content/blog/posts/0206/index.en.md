...
It's been five years since {{< intref "/software/dklang-localization-package" "DKLang Localization Package" >}} was last revised (time flies!). You might think that it had been abandoned, but no, it did its intended job well enough and it was solid enough that it didn't need an update.
