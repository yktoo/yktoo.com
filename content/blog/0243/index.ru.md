...
* **Входы и выходы**
    ...
    * [Камера]({{< relref "/blog/0245" >}}): приобретается отдельно, подключается по USB
* **Поддержка Smart TV**
    * Samsung Smart Hub
...
*Далее:* [Часть вторая. Подключение и управление]({{< relref "/blog/0244" >}})
