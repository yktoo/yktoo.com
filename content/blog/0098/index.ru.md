...
Зато имена у «грешников» хитроумные, как и их прикиды (про макияж вообще молчу). Певицу, на лицо типичнейшую голландку, нарекли Лотусом (//Lotus//). Гитаристов звать //Gen Morphine// (который регулярно дополнял вакханалию своим гроул-вокалом) и //Tristan Hex// (этот не пел, зато у него к бедру был приаттачен противогаз — я не знаю, зачем, но он присутствует и у их альбома [Perversion Ltd.](http://www.amazon.com/Perversion-Ltd-Explicit/dp/B003KZE350/) на обложке). Басист отличился не только дредами, но и тяжёлым фартуком до пола и именем //JD Acid//, да и ударник тоже не вчера родился, имя ему //Heresy 101//.
...
Зато один из двух гитаристов, //Stephan Schultz//, играл неплохо. Местами даже тэппингом.
![](img:4.bp.blogspot.com/-BUa5DvySPiE/TgXg-LYbjKI/AAAAAAAAItc/mfORKfVsY_s/s1600/dsc04648.picasaweb.jpg:a)

Но больше всех старался, безусловно, басист //Johan van Stratum//. Он носился по сцене, как раненый кролик, постоянно появляясь в разных её углах, прыгая с разных её частей, маша зрителям и вертя гитарой так, что мне всё казалось, что он её вот-вот выронит. Не выронил. Вот он, на заднем плане справа:
![](img:1.bp.blogspot.com/-AVhoUEcDL5g/TgXgzkIvp7I/AAAAAAAAItc/QoyDkEKw9aU/s1600/dsc04419.picasaweb.jpg:a)

Второй гитарист, //Eric Hazebroek// — грузный и длинноволосый, внешне чем-то напоминает [Марсела Кунена из Sun Caged][post:22], но на этом сходство и заканчивается. Марсел играет так, что ему и не снилось.
![](img:4.bp.blogspot.com/-oMGp1ExZ3LA/TgXgrYtpB_I/AAAAAAAAItc/9CrdJzG3niA/s1600/dsc04392.picasaweb.jpg:a)

Саунд был громким. От звука бочки //Martijn Peters// печень стукалась об селезёнку. А от баса Ван Стратума все остальные внутренние органы входили в резонанс. Временами группа давала зрителям передышку, играя номера поспокойнее.
![](img:4.bp.blogspot.com/-pChIL9cXi64/TgXgiNV5ySI/AAAAAAAAItc/AiqFnnGti5Q/s1600/dsc04691.picasaweb.jpg:a)

Здесь Марсела Бовио поёт под клавишные под управлением //Jeffrey Revet//.
