...
Расположенный на территории //Schlosspark// (что переводится просто как «дворцовый парк»), дворец Шёнбрун (//Schönbrunn//) — одно из лучших мест в Вене.
...
«Венский завтрак» (//Wiener Frühstück//) около 12 дня, на палящем солнце:
...
А нам пора уже в Венгрию. Спешим на вокзал //Wien Meidling//, откуда отправляются поезда в Будапешт.

Продолжение: [Часть 5. Поезд на Будапешт][post:87]
