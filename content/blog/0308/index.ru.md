...
Очень часто веб-приложения используют базу данных для хранения различной информации. В минувшие годы большое распространение получил стек (набор технологий) под названием [LAMP][wiki:ru:LAMP] ({{< fl "Linux" >}}, {{< fl "Apache" >}}, {{< fl "MySQL" >}}, {{< fl "PHP" >}}), которым в своё время воспользовался для создания этого сайта и я.
