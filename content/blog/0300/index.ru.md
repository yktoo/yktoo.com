...
{{< fl "London Eye" >}} («[Лондонский глаз][wiki:ru:Лондонский_глаз]»), он же {{< fl "Millennium Wheel" >}}, он же «Колесо Кока-Колы» ({{< fl "Coca-Cola Wheel" >}}) — огромное колесо обозрения высотой **135 метров**, установленное прямо на берегу Темзы напротив [Вестминстерского дворца]({{< relref "/blog/0299#westminster" >}}).
