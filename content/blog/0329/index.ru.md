...
Настало время обновить свой самый увесистый гаджет. Уже лет девять я остаюсь приверженцем гибридов [Toyota Prius][wiki:ru:Toyota_Prius], начиная с [первой, лизинговой машины][post:28]. Потом была ещё одна — уже своя, которая давеча [чуть не охромела][post:304]. В марте этого года старушке стукнуло восемь лет и пора было менять её на что-то более современное.
...
У //plug-in hybrid// аккумулятор можно подзаряжать от обычной розетки. У моего //Prius// батарея уже литий-ионная, ёмкостью **4,4 кВт·ч**. Это, конечно, не [Tesla Model S][wiki:ru:Tesla_Model_S] с огромным аккумулятором в 70-90 кВт·ч. На полностью заряженном //Prius PHV// в электрическом режиме можно проехать примерно **18-20 км**. Это, с одной стороны, не особенно много, а с другой — вполне достаточно, чтобы съездить за продуктами или на шопинг в соседний город и обратно. Для перехода в режим //EV// и обратно есть отдельная кнопка, но, если заряд на исходе или резко нажата педаль газа, режим //EV// автоматически выключится. Также он временно выключается, если машина разгоняется до **90 км/ч**.
...
В дополнение к традиционному аналоговому радио с //FM// и //AM// (зачем здесь последний, хоть убей, не пойму) в моей модели появилось цифровое [DAB+][wiki:en:Digital_audio_broadcasting], наконец-то я могу слушать //BBC//! Качество звука в //DAB+// несравнимо выше, но связь всё равно периодически пропадает.
...
Моя модель оснащена [TMC][wiki:ru:Канал_автодорожных_сообщений], радиомодулем, непрерывно получающим информацию о пробках и закрытых дорогах. Эта информация может учитываться системой при выборе маршрута, но я этим не пользуюсь, потому что предлагаемые ей альтернативные маршруты, как правило, совершенно дикие.
