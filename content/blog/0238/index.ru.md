...
Минул год, и я, как и [обещал][post:213], нагрянул на гентский фестиваль света ([Ghent Light Festival](http://www.lichtfestivalgent.be/)).

![](img:1.bp.blogspot.com/-YxmmwHkb-qo/VM6ccpInzhI/AAAAAAAAg9Y/Pxihf6qwvMA/s1600/dsc07961.picasaweb.jpg:a "Katarzyna Malejka и Joachim Slugocki — «Горизонтальная интерференция».")
...
![](img:1.bp.blogspot.com/-77rTXELjB_w/VM6cY8g72SI/AAAAAAAAg8w/5DyY43WC7Rs/s1600/dsc07954.picasaweb.jpg:a "Гентское нашествие светопоклонников.")

Этот фестиваль, третий по счёту, проходил с четверга 29 января по воскресенье первого февраля в бельгийском городке Генте (нидерл. //Gent//, англ. //Ghent//), в котором я [был][post:212] около года назад.
...
![](img:3.bp.blogspot.com/-PdDIi6H1PV0/VM6b9MzoxVI/AAAAAAAAg4w/G3cxo56ue48/s1600/dsc07915.picasaweb.jpg:a "Замок Графов Фландрии.")
...
Впрочем, музыкой это можно было назвать с большой натяжкой. Скорее, ритмичная последовательность звуков. Вот видео этого действа под названием //Globoscope//:
![](youtube:1MIQdB14CIU)
...
Дальше — больше. Вот эта зелёная паутина, сплетённая [THEM Sculptures](http://www.themsculptures.com/), почему-то называется «Наш дом Гент» (//Our House Ghent//):
...
Музыкальное сопровождение при этом очень походит на предыдущее, вот короткий ролик, снятый через головы толпы, плотно забившей //Mageleinstraat//:
![](youtube:Qr76VoO4m34)

Был здесь и более традиционный вид светоразвлечения, интерактивная проекция, подогнанная под форму существующего здания. Эта, например, называется «Танцующий дом» (//Dancing House//) австрийца [Клауса Обермайера](http://www.exile.at/):
...
![](img:3.bp.blogspot.com/-QXt7mpwaI_Q/VM6cOLRiCiI/AAAAAAAAg7I/QsW6rkEJWkE/s1600/dsc07938.picasaweb.jpg:a "Теплоходы с туристами.")

Гентчане слегка приукрасили свои дома к фестивалю — кто-то цветом.
![](img:4.bp.blogspot.com/-EI4XAt12seo/VM6cU9kgxxI/AAAAAAAAg8I/WYFq0Mc2jXU/s1600/dsc07947.picasaweb.jpg:a "Зелёный 't Kadehuis.")
...
Здание бывшего «большого дома мяса» (//Het Groot Vleeshuis//), ныне [Центр продвижения региональных продуктов Восточной Фландрии](http://www.grootvleeshuis.be/):
...
Проекция пониженной интерактивности ~~для бедных~~ [Клаудии Рэ](http://www.echtzeitlicht.eu/) //Echtzeitlicht//:
...
И ещё одна интерактивная проекция «Звук света» (//The Sound of Light//) от [Ocubo](http://www.ocubo.com/) — с анимацией, но не задела. Видео просто проецируется на стену дома, и нет никакой привязки к конкретной архитектуре. Так неинтересно.
...
А пока что у нас медитация. Голографические квадратокруги авторства [Nonotak](http://www.nonotak.com/) по имени //Daydream V2//:
...
Продолжаем тему медитации. Самая первая картинка из этого поста — композиция «Горизонтальная интерференция» (//Horizontal Interference//), состоящая из сиреневых нитей, натянутых между домами.
![](img:2.bp.blogspot.com/-zt1PdCRVAS8/VM6cbWgBYII/AAAAAAAAg9I/zEpT1HX9Fro/s1600/dsc07959.picasaweb.jpg:a "Katarzyna Malejka и Joachim Slugocki — Horizontal Interference.")
...
![](img:1.bp.blogspot.com/-kzcOxM5IsIo/VM6cdbYVxGI/AAAAAAAAg9g/g490iGg2gTY/s1600/dsc07963.picasaweb.jpg:a "Katarzyna Malejka и Joachim Slugocki — Horizontal Interference.")
...
Но, вообще говоря, самая давка была на углу //Nieuwbrugkaai//, где очередной экспонат водрузили прямо посреди Лейе. //Mysticète// изготовления студии [Top'La Design](http://www.topla-design.com/) представляло собой замысловатой конструкции фонтан, на который проецировалось видеоизображение, плюс несколько дополнительных прожекторов. Пробиться в первые ряды зрителей не было совершенно никакой возможности — нужно было простоять, наверное, часа два. Но мне удалось снять видео таинства, происходящего за глухой стеной из спин, подняв камеру на штативе:
![](youtube:T3FwQfN9KzY)
...
Старый Звериный рынок (//Oude Beestenmarkt//) охраняли Огромные Светящиеся Кроликоподобные Роботы.
...
Куча светящихся столбов — это творение «Древесина» (//The Wood//) от //Dex Voil//, иллюстрирующее «хрупкое равновесие между городом, природой и технологией». Люди (в основном, дети), бродящие среди столбов, влияют на их цвет.
![](img:3.bp.blogspot.com/-TPYoUzYMmR0/VM6chQToqSI/AAAAAAAAg-I/6HmhieCXYQs/s1600/dsc07976.picasaweb.jpg:a)

Торжество минимализма, «Нарисованные в свете» (//Drawn in light//) голландца [Ралфа Вестерхофа](http://www.ralfwesterhof.nl/), медленно вращающиеся в свете прожекторов:
...
Обалденная, качественная анимация //Horta// от [Théoriz](http://www.theoriz.com/), изображающая известных гентцев и проецируемая на фасад Епископального Дома (//Bisschopshuis//):
![](youtube:lKWYyZe0wvk)
...
Это был безусловный лидер (у него даже номер в [программе фестиваля](http://www.lichtfestivalgent.be/en/programma/) — 1). Интерактивная проекция размером с целый квартал на площади //Sint-Pietersplein//, покрывающая три здания. Автором числится группа со странным названием [Dirty Monitor](http://www.dirtymonitor.com/) («Грязный монитор»):
