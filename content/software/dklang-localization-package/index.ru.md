...
* Хранение переводов в обычных текстовых файлах, доступных для редактирования любым текстовым редактором. Кроме того, имеется и намного более совершенный инструмент для редактирования переводов, {{< a "/software/dklang-translation-editor" "DKLang Translation Editor" >}}, предоставляющий гораздо больше возможностей.
